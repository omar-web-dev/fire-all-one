                                ...
                                <form>
                                    ...
                                    <div className="mb-10">
                                        <button
                                            type="submit"
                                            value="Sign In"
                                            className="bg w-full cursor-pointer rounded-md border bg-primary p-3 text-base text-white transition hover:bg-opacity-90 text-red-500 font-semibold text-xl"
                                        >SUBMIT</button>
                                    </div>
                                </form>
